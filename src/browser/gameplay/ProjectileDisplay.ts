...
import { ProjectileObserver, Projectile, PROJECTILE_LIFETIME, UFO, Ship } from "../../core";
...
export class ProjectileDisplay extends Graphics implements ProjectileObserver, Tickable {
