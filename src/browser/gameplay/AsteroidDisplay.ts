...
import { Asteroid, AsteroidDestroyOptions, AsteroidObserver, ASTEROID_HITAREAS } from "../../core";
...
export class AsteroidDisplay extends Container implements AsteroidObserver, Tickable {
    ...
    onDestroy({ hit }: AsteroidDestroyOptions): void {
        if (hit && this.parent) {
